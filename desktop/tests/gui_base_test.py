...
from onionetwork import Application, MainWindow, GuiCommon
from onionetwork.tab.mode.share_mode import ShareMode
from onionetwork.tab.mode.receive_mode import ReceiveMode
from onionetwork.tab.mode.website_mode import WebsiteMode
from onionetwork.tab.mode.chat_mode import ChatMode
from onionetwork import strings


class GuiBaseTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        common = sys.onionetwork_common
        qtapp = sys.onionetwork_qtapp
    ...
    def window_title_seen(self):
        """Test that the window title is onionetwork"""
        self.assertEqual(self.gui.windowTitle(), "onionetwork")
