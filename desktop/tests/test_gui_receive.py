...
class TestReceive(GuiBaseTest):
    ...
    def upload_file_should_fail(self, tab):
        ...
        self.assertTrue("Error uploading, please inform the onionetwork user" in r.text)
    ...
    def run_all_receive_mode_tests(self, tab):
        ...
        self.submit_message(tab, "onionetwork is an interesting piece of software")
    ...
    def run_all_upload_non_writable_dir_tests(self, tab):
        ...
        upload_dir = os.path.join(self.tmpdir.name, "onionetwork")
    ...
    def test_405_page_returned_for_invalid_methods(self):
        ...
        self.hit_405(url, expected_resp="onionetwork: 405 Method Not Allowed", data = {'foo':'bar'}, methods = ["put", "post", "delete", "options"])
