...
def main():
    ...
    common = onionetwork_cli.common.Common()
    settings = onionetwork_cli.settings.Settings(common)
    ...
    os.makedirs(os.path.join("onionetwork", "resources", "countries"), exist_ok=True)
    for locale in available_locales:
        ...
        with open(
            os.path.join("onionetwork", "resources", "countries", f"{locale}.json"),
            "w",
        ) as f:
