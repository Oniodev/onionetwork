...
from onionetwork_cli.onionetwork import onionetwork
from onionetwork_cli.web import Web
from onionetwork_cli.mode_settings import ModeSettings
...
class Tab(QtWidgets.QWidget):
    ...
    def __init__(
        ...
        # Start the onionetwork app
        self.app = onionetwork(common, self.common.gui.onion, self.common.gui.local_only)
