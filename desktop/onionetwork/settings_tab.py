...
class SettingsTab(QtWidgets.QWidget):
    ...
    def __init__(self, common, tab_id, parent=None):
        ...
        # Populate the dropdown with all of onionetwork's available languages
    ...
    def save_clicked(self):
        ...
        if settings:
            # If language changed, inform user they need to restart onionetwork
            ...
            # If color mode changed, inform user they need to restart onionetwork
    ...
    @staticmethod
    def open_help():
        help_url = "https://docs.onionetwork.org/"
