...
from . import strings
from onionetwork_cli.onion import (
    Onion,
...
from onionetwork_cli.meek import Meek
from onionetwork_cli.web.web import WaitressException

class GuiCommon:
    """
    The shared code for all of the Onionetwork GUI.
    """
    ...
    def get_resource_path(filename):
        ...
        """
        try:
            ref = importlib_resources.files("onionetwork.resources") / filename
