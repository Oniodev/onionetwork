...
class UpdateCheckerCheckError(Exception):
    ...
    the onionetwork website is down.
    """
...
class UpdateChecker(QtCore.QObject):
    ...
    version of onionetwork is. If the latest version is newer than the
    ...
    def check(self, force=False):
        ...
        if check_for_updates:
            ...
            try:
                # User agent string includes Onionetwork version and platform
                user_agent = f"Onionetwork {self.common.version}, {self.common.platform}"
                ...
                self.common.log(
                    "UpdateChecker",
                    "check",
                    f"latest onionetwork version: {latest_version}",
                )
            ...
            update_url = "https://onionetwork.org"
