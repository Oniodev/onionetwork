...
class MainWindow(QtWidgets.QMainWindow):
    """
    MainWindow is the onionetwork main window, which contains the GUI elements, including all open tabs
    """
    ...
    def __init__(self, common, filenames):
        ...
        self.setWindowTitle("Onionetwork")
    ...
    def tor_connection_canceled(self):
        ...
        def ask():
            ...
            if a.clickedButton() == quit_button:
                # Quit
                self.common.log(
                    "onionetworkGui", "_tor_connection_canceled", "Quit button clicked"
                )
    ...
    def event(self, event):
        # Check if color mode switched while onionetwork was open, if so, ask user to restart
