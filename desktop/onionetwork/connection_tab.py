...
from onionetwork_cli.censorship import (
    CensorshipCircumvention,
    CensorshipCircumventionError,
)
from onionetwork_cli.meek import (
    MeekNotRunning,
    MeekNotFound,
)
...
class AutoConnectTab(QtWidgets.QWidget):
    ...
    def check_for_updates(self):
        """
        Check for onionetwork updates in a new thread, if enabled.
        """
...
class AutoConnectFirstLaunchWidget(QtWidgets.QWidget):
    """
    When you first launch onionetwork, this is the widget that is displayed
    """
